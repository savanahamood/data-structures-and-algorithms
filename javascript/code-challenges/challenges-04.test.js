...
const alphabetize = (arr) => {
  ...
  return arr.sort((a, b) => a.localeCompare(b, 'en', { caseFirst: 'upper' })).sort();
...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((a, b) => a.lastName.localeCompare(b.lastName, { sensitivity: 'base' }));
...
const sortPeopleBetter = (arr) => {
  // Solution code here...
  return arr.sort((a, b) => {
    const x = a.lastName.toLowerCase().localeCompare(b.lastName.toLowerCase());
    if (x !== 0) {
      return x;
    }

    const y = a.firstName.toLowerCase().localeCompare(b.firstName.toLowerCase());
    if (y !== 0) {
      return y;
    }
